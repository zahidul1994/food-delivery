...
class POSController extends Controller
{
    public function index(Request $request)
    {
        ...
        $products = Product::with('product_by_branch')
    ...
    {
        $product = Product::with('product_by_branch')->findOrFail($request->product_id);
        //dd($product);
    ...
    public function variant_price(Request $request)
    {
        ...
        $branch_product = ProductByBranch::where(['product_id' => $request->id, 'branch_id' => auth('branch')->id()])->first();
...
//
//                $price_total =  $price + Helpers::new_variation_price($product_variations, $request->variations);
        ...
        foreach ($cart as $c) {
            if (is_array($c)) {
                ...
                if ($product) {
                    ...
                    $branch_product = ProductByBranch::where(['product_id' => $c['id'], 'branch_id' => auth('branch')->id()])->first();
